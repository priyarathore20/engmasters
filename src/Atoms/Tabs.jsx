...
const days = [
  { dayNumber: "Day 1", day: "Mon" },
  { dayNumber: "Day 2", day: "Tues" },
  { dayNumber: "Day 3", day: "Wed" },
  { dayNumber: "Day 4", day: "Thu" },
  { dayNumber: "Day 5", day: "Fri" },
];
          ...
          <div key={tab.label} className="flex justify-between w-full">
            <div className="flex flex-col flex-[0.3] gap-5">
              {days.map((day, i) => (
                <div
                  key={i}
                  className="flex flex-col justify-center items-center gap-1 bg-bgGray/55 rounded-xl w-full max-w-44 h-full"
                >
            ...
            <div className="flex flex-col flex-[0.9] gap-5">
              {tab.content.map((item, index) => (
                <div key={index} className="bg-bgGray/55 p-5 rounded-lg">
